...
public class UpdateDetailsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<caption>UPDATE PERSONAL INFORMATION</caption>");            
            out.println("<form action=UpdateUserServlet method=post>");
            out.println("<tr><td>Username: </td> <td><input type=\"text\" name=\"username\" value="+ShowMenuServlet.username+"></td>");
