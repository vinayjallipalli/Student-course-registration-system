...
public class UpdateUserServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String deptid,username, password,email_id,city ;
            int contact_number,gpa,sem;
            ...
            contact_number= Integer.parseInt(request.getParameter("contact_number"));
            ...
            UserJDBCTemplate userJDBCTemplate= (UserJDBCTemplate) applicationContext.getBean("UserJDBCTemplate");
             try{
            userJDBCTemplate.update(username, password,deptid,gpa,sem,email_id, contact_number, city);
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Information updated successfully!</h1>");
            out.println("</body>");
            out.println("</html>");
             }
            catch(Exception e)
